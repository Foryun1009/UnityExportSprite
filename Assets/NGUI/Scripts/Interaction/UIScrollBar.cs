...
public class UIScrollBar : UISlider
{
    ...
    public void f_LeftArray()
    {
        value -= 0.01f;
    }

    public void f_RightArray()
    {
        value += 0.01f;
    }
    ...
    void LateUpdate()
    {
        ...
        else if (_RightArrayPress)
        {
            value += 0.01f;
        }
    }

    private bool _LeftArrayPress = false;
	public void f_LeftPress()
	{
        _LeftArrayPress = true;
	}


    public void f_LeftRelease()
    {
        _LeftArrayPress = false; 
    }


    private bool _RightArrayPress = false;
    public void f_RigthPress()
    {
        _RightArrayPress = true;
    }


    public void f_RigthRelease()
    {
        _RightArrayPress = false;
    }
